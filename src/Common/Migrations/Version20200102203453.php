 ...
 */
final class Version20200102203453 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE virtual_users (id VARCHAR(64) NOT NULL, domain_id VARCHAR(64) DEFAULT NULL, email VARCHAR(100) NOT NULL, password VARCHAR(150) NOT NULL, quota INT NOT NULL, roles JSON NOT NULL, INDEX IDX_3C68956A115F0EE5 (domain_id), UNIQUE INDEX email (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
